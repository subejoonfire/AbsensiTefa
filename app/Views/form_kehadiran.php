...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('/css/form_kehadiran.css') ?>">
    ...
    <div class="container">
        <div class="popup" id="my-popup">
            ...
            <div class="body-popup">
                ...
                <br>
                <div class="options">
                    <form action="<?= base_url('keluarAction') ?>" method="get">
        ...
        <div class="body-container">
            ...
            <form action="<?= base_url('/kehadiranAction') ?>" method="post">
                <div class="nama-container">
                    <span> Nama :</span>
                    <input type="text" name="namamhs" value="<?= session('username') ?>" readonly id="">
                </div>
...
<script>
    ...
    function showPosition(position) {
        ...
        // console.log(locationStatus.value)
    }
