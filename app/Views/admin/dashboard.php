...
<body>
    <div class="container">
        ...
        <div class="body-container">
            <a class="logoutButton" href="<?= base_url('/logout') ?>">Logout</a>
            ...
            <div class="dates">
                ...
                <div class="body-dates" id="datesContainer" hidden>
                    ...
                    ?>
                        <a href="<?= base_url('/dashboardFilter/'), $row['tanggal'] ?>"><?= date('l, j F Y', strtotime($row['tanggal'])) ?></a>
                    <?php
                    }
                    ?>
                </div>
